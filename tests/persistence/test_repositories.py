...
from src.voyager_trader.persistence.repositories import (
    AccountRepository, AuditLogRepository, OrderRepository,
    PortfolioRepository, PositionRepository, TradeRepository
)
...
@pytest.mark.asyncio
async def test_position_repository_crud(db_manager, sample_account, sample_portfolio, sample_position):

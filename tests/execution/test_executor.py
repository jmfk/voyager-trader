...
from src.voyager_trader.execution.executor import StrategyExecutor, StrategySignal, ExecutionConfig
from src.voyager_trader.execution.interfaces import PaperBroker
from src.voyager_trader.execution.risk import RiskManager, RiskLimits
...
class TestStrategyExecutor:
    ...
    async def test_register_strategy(self, strategy_executor):
        ...
        result = await strategy_executor.register_strategy("test-strategy", Decimal("15"))
    ...
    async def test_register_strategy_allocation_limit(self, strategy_executor):
        ...
        result = await strategy_executor.register_strategy("big-strategy", Decimal("25"))
    ...
    @pytest.mark.asyncio
    async def test_execute_buy_signal_unregistered_strategy(self, strategy_executor, buy_signal):
    ...
    @pytest.mark.asyncio
    async def test_execute_buy_signal_success(self, strategy_executor, buy_signal, paper_broker):
    ...
    @pytest.mark.asyncio
    async def test_execute_sell_signal_no_position(self, strategy_executor, sell_signal):
    ...
    @pytest.mark.asyncio
    async def test_execute_sell_signal_success(self, strategy_executor, buy_signal, sell_signal, paper_broker):
    ...
    async def test_concurrent_order_limit(self, strategy_executor, paper_broker):
        ...
        paper_broker.set_price("AAPL", Decimal("155.00"))  # Unfavorable for limit orders
    ...
    async def test_emergency_stop(self, strategy_executor):
        ...
        assert "emergency" in strategy_executor.risk_manager.get_shutdown_reason().lower()

...
from src.voyager_trader.execution.interfaces import PaperBroker, ExecutionResult
from src.voyager_trader.models.trading import Order
from src.voyager_trader.models.types import Money, OrderSide, OrderStatus, OrderType, Quantity, Symbol
...
class TestPaperBroker:
    ...
    @pytest.mark.asyncio
    async def test_limit_order_execution_favorable_price(self, paper_broker, sample_limit_order):
    ...
    @pytest.mark.asyncio
    async def test_limit_order_no_execution_unfavorable_price(self, paper_broker, sample_limit_order):
    ...
    async def test_current_price_generation(self, paper_broker):
        ...
        price = await paper_broker.get_current_price(Symbol(code="TSLA", asset_class="equity"))
        ...
        price2 = await paper_broker.get_current_price(Symbol(code="TSLA", asset_class="equity"))
        assert price2 == price
